...
public final class DigAffinitySubmoduleItem extends Item implements OverloadArmorSubmoduleItem {

    private static final DigAffinitySubmodule INSTANCE = DigAffinitySubmodule.INSTANCE;
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("item.ae2lt.module_dig_affinity.tooltip")
