...
public final class CleanseSubmoduleItem extends Item implements OverloadArmorSubmoduleItem {

    private static final CleanseSubmodule INSTANCE = CleanseSubmodule.INSTANCE;
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("item.ae2lt.module_cleanse.tooltip")
