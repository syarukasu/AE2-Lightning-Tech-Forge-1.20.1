...
public class LightningSimulationOutputConfigScreen
        extends AESubScreen<LightningSimulationChamberMenu, LightningSimulationChamberScreen> {
    ...
    public LightningSimulationOutputConfigScreen(LightningSimulationChamberScreen parent) {
        ...
        clear.setMessage(Component.translatable("ae2lt.gui.lightning_simulation.output_side.clear"));
    ...
    private LightningSimulationOutputButton addSideButton(String widgetId, RelativeSide side, String labelKey) {
        var button = new LightningSimulationOutputButton(
