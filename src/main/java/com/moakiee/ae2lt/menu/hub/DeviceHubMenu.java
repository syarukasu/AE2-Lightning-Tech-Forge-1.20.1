...
public class DeviceHubMenu extends AbstractContainerMenu {
    ...
    public void toggleRailgunTerrain() {
        ...
        RailgunSettings s = ModDataComponents.getRailgunSettings(railgun);
        ModDataComponents.setRailgunSettings(railgun, s.withTerrain(!s.terrainDestruction()));
    }
    ...
    public void toggleRailgunPvp() {
        ...
        if (railgun.isEmpty()) return;
        RailgunSettings s = ModDataComponents.getRailgunSettings(railgun);
        ModDataComponents.setRailgunSettings(railgun, s.withPvp(!s.pvp()));
    }
    ...
    public void toggleRailgunSound() {
        ...
        if (railgun.isEmpty()) return;
        RailgunSettings s = ModDataComponents.getRailgunSettings(railgun);
        ModDataComponents.setRailgunSettings(railgun, s.withSound(!s.soundEnabled()));
    }
