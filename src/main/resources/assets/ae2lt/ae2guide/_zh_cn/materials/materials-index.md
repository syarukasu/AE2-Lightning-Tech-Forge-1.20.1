...
漂浮物质是一种通过捕获潜影贝弹获得的材料。接入激活 ME 网络且带有精准采集的 <ItemLink id="ae2:annihilation_plane" /> 可以消耗撞上它的潜影贝弹，并向网络存储插入 <ItemLink id="ae2lt:floating_matter" />。详见 [漂浮物质](floating-matter.md)。
