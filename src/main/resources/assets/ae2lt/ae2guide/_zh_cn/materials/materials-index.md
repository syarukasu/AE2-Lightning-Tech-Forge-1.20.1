...
| 物品 | 说明 |
|------|------|
| 过载处理器 | 高级处理器，用于制作过载机器 |
| 过载电路板 | 由过载压印模板配合 AE2 压印器制造 |
| 未过载的电路板 | 过载电路板的中间产物 |
| 过载压印模板 | 用于在 AE2 压印器中制造过载电路板 |
...
| 物品 | 说明 |
|------|------|
| 过载样板 | 专用样板，仅可在过载样板供应器中使用 |
| 过载样板编码器 | 用于编码过载样板，支持设置副产物与忽略 NBT |
| 过载无线连接工具 | 用于为过载样板供应器 / 过载 ME 接口建立与远程机器的无线连接 |
| 过载过滤元件 | 为过载 ME 接口配置允许导入的物品 |
